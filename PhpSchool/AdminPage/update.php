...
if (include_once('./config.php')) {
    ...
    $sql = "UPDATE `tbl_adventure` SET `pro_name`='$name1',`img`='$img1',`size`='$size1',`point`='$point1',`price`='$price1',`type_product`='$type1',`discount`='$discount',`des`='$des1' WHERE `pro_id`='$id'";
